...
namespace v2 {
	...
	void Player::decideShotAngle(float maxA, float minA) { return (this->*union_cast<bool(Player::*)(float,float)>(0x4877C0))(maxA, minA); }//set this+0x7F0, which is now gpFloat[5]
